...
namespace Auto_Soft_Installer
{
    ...
    public static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Library.Library.AddToStartupPrograms("Software Auto-install");


            var sleepPeriod = Convert.ToInt32(Library.Library.SettingsReader("sleepPeriod"));
            ...
            while (!app.IsFinished)
            {
                ...
                if (app.AnyException)
                {
                    Library.Library.LogFileWriter("Exception levée, reprise du service après " + sleepPeriod +
                                                  " secondes");
                    Library.Library.MessageBoxDisplayer("Contactez vos administrateurs réseau et systéme !");
